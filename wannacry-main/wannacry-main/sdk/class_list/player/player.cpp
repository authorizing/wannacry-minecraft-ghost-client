...
std::shared_ptr<__player> wcry::local_player = NULL;
...
vec3 __player::get_pos() {
    ...
    ZwReadVirtualMemory(wcry::p_handle, (LPVOID)field, &pos, 24, 0);
...
float __player::get_yaw() {
    ...
    ZwReadVirtualMemory(wcry::p_handle, (LPVOID)field, &yaw, 4, 0);
...
void __player::set_yaw(float yaw) {
    ...
    ZwWriteVirtualMemory(wcry::p_handle, (LPVOID)field, &yaw, 4, 0);
...
float __player::get_pitch() {
    ...
    ZwReadVirtualMemory(wcry::p_handle, (LPVOID)field, &pitch, 4, 0);
...
void __player::set_pitch(float pitch) {
    ...
    ZwWriteVirtualMemory(wcry::p_handle, (LPVOID)field, &pitch, 4, 0);
...
vec3 __player::get_motion() {
    ...
    ZwReadVirtualMemory(wcry::p_handle, (LPVOID)field, &motion, 24, 0);
...
void __player::set_motion(vec3 motion) {
    ...
    size_t field = this->address + 72;
    ZwWriteVirtualMemory(wcry::p_handle, (LPVOID)field, &motion, 24, 0);
...
int __player::get_hurt_timer() {
    ...
    ZwReadVirtualMemory(wcry::p_handle, (LPVOID)field, &hurt_timer, 4, 0);
